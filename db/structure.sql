CREATE TABLE "addresses" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "address_line1" varchar(255), "address_line2" varchar(255), "city" varchar(255), "state" varchar(255), "pincode" varchar(255), "country" varchar(255), "place_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "latitude" float, "longitude" float, "gmaps" boolean);
CREATE TABLE "authentications" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" integer, "provider" varchar(255), "uid" varchar(255), "token" varchar(255), "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
CREATE TABLE "deals" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "start_date" date, "end_date" date, "price" float, "guests" integer, "user_id" integer, "place_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "state" integer DEFAULT 0);
CREATE TABLE "details" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "accomodation" integer, "bedrooms" integer, "beds" integer, "bed_type" varchar(255), "bathrooms" integer, "size" float, "unit" integer, "pets" boolean, "place_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE "places" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar(255), "description" text, "property_type" integer, "room_type" integer, "daily_price" float, "weekend_price" float, "weekly_price" float, "monthly_price" float, "additional_guests" integer, "additional_price" float, "user_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "verified" boolean DEFAULT 'f', "hidden" boolean DEFAULT 'f');
...
CREATE TABLE "users" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "first_name" varchar(255), "last_name" varchar(255), "email" varchar(255), "password_digest" varchar(255), "gender" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "birth_date" date, "school" varchar(255), "describe" text, "live" varchar(255), "work" varchar(255), "verified" boolean DEFAULT 'f', "avatar_file_name" varchar(255), "avatar_content_type" varchar(255), "avatar_file_size" integer, "avatar_updated_at" datetime, "wallet" float DEFAULT 0.0, "admin" boolean DEFAULT 'f', "activation_link" varchar(255), "activated" boolean DEFAULT 't');
...
INSERT INTO schema_migrations (version) VALUES ('20120924053254');

INSERT INTO schema_migrations (version) VALUES ('20120927052717');